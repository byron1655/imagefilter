...
class ImageFilter {
    ...
    private function imagesources($imgad){
        ...
        switch($imagearray[2]){//1=GIF,2=JPG,3=PNG,4=SWF,5=PSD,6=BMP,7=TIFF(intel byte order),8=TIFF(motorola byte order),9=JPC,10=JP2,11=JPX,12=JB2,13=SWC,14=IFF,15=WBMP,16=XBM
            case 1://gif
                $this->imgtype = 1;
    ...
    private function proimagesize(){
        if($this->scaling_height && ($this->width < $this->height)) {//等比缩放算法
